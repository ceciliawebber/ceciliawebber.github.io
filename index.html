...
@media (max-width: 480px) {
	...
	<section id="contact" class="row">
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-6">
				<strong>Email</strong>
				<div class="email">cawebber@bu.edu</div>
			</div>
			<div class="col-sm-6">
				<strong>Phone</strong>
				<div class="phone"> </div>
	...
	<section id="about" class="row">
		...
		<div class="col-sm-9">
			<p>I am an undergraduate at Boston University (Go Terriers!). I am originally from a small town in New Hampshire.</p>
		</div>
	</section>
		...
		<div class="col-sm-9">
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="username">
						<div class="url">
							<a href="https://twitter.com/ceciliawebber_">@ceciliawebber_</a>
						</div>
					</div>
				</div>
			</div>
	...
	<section id="volunteer" class="row">
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-12">
				<h4 class="strike-through">
					<span>Society of Hispanic Professional Engineers</span>
					<span class="date">
